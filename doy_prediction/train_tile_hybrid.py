...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train crop-specific hybrid CNN-start/RNN-end harvest window regressors."
    )
    ...
    parser.add_argument(
        ...
        default=[32, 64, 128],
        metavar=("C1", "C2", "C3"),
        help="Three CNN channel sizes. Defaults to 32 64 128.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Optional per-layer RNN hidden sizes, for example: --rnn-hidden-sizes 32 64 128.",
    )
...
def main() -> None:
    ...
    model_config = {
        ...
        "rnn_hidden_sizes": args.rnn_hidden_sizes,
    ...
    for crop in args.crops:
        ...
        train_crop_model(
            ...
            min_points=args.min_points,
            model_factory=lambda in_channels: TileCNNRNNHybridRegressor(
