...
# python -m create_doy_prediction_input.main_previous_vr --dataset-root ../AR_sentinel2/2019_AR --cdl-yaml configs/Arkansas/cdl.yaml --gt-windows-yaml configs/Arkansas/gt_windows.yaml --output-root outputs/2019_AR --summarize --cleanup-npy
